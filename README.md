...
```bash
# if root
wget -qO - https://raw.githubusercontent.com/arrowmaster/pve-patch/master/patch.sh | bash

# if non-root
wget -qO - https://raw.githubusercontent.com/arrowmaster/pve-patch/master/patch.sh | sudo bash
```
